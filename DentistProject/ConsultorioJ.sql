...
USE `consultorio` ;
-- -----------------------------------------------------
-- Table `consultoriod`.`actividades`
-- -----------------------------------------------------
---------------------------------
-- Table `consultoriod`.`pacientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `consultorio`.`pacientes` (
  ...
  `tratamiento` VARCHAR(35) NOT NULL,
  `actividades` VARCHAR(10) NOT NULL,
  `dia` INT(11) NOT NULL,
  `mes` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `consultoriod`.`hclinica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `consultorio`.`hclinico` (
  ...
  CONSTRAINT `hclinica_ibfk_1`
    ...
    REFERENCES `consultorio`.`pacientes` (`idPaciente`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


-- -----------------------------------------------------
-- Table `consultoriod`.`productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `consultorio`.`productos` (
